---
title: "Week 10 HW - Money in US politics"
author:
...
::: {.box}
Complete the following set of steps in the `scrape-pac.R` file in the `scripts` folder.
...
Complete the following set of steps in this markdown file.
...
🧶 Now is a good time to knit your document.
...
knitr::include_graphics("img/LineGraph.png")
